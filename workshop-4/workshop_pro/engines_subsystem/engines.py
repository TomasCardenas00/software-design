...
class HybridEngine(Engine):
    """This class represents the behavior of an hybrid engine"""

    def __init__(self, torque: int, maximum_speed: int, dimenssions: str, power: int, stability: str, weight: float, electric_power: int):
